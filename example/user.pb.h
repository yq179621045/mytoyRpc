...
template<> ::lan::RegisterRequest* Arena::CreateMaybeMessage<::lan::RegisterRequest>(Arena*);
template<> ::lan::RegisterResponse* Arena::CreateMaybeMessage<::lan::RegisterResponse>(Arena*);
...
class RegisterRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lan.RegisterRequest) */ {
 public:
  RegisterRequest();
  ...
  // @@protoc_insertion_point(class_scope:lan.RegisterRequest)
 private:
  class _Internal;
...
class RegisterResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lan.RegisterResponse) */ {
 public:
  RegisterResponse();
  ...
  // @@protoc_insertion_point(class_scope:lan.RegisterResponse)
 private:
  class _Internal;
...
inline bool LoginResponse::sucess() const {
  // @@protoc_insertion_point(field_get:lan.LoginResponse.sucess)
...
inline void LoginResponse::set_sucess(bool value) {
  ...
  // @@protoc_insertion_point(field_set:lan.LoginResponse.sucess)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequest::id() const {
  // @@protoc_insertion_point(field_get:lan.RegisterRequest.id)
  return _internal_id();
}
...
inline void RegisterRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lan.RegisterRequest.id)
}
...
inline const std::string& RegisterRequest::name() const {
  // @@protoc_insertion_point(field_get:lan.RegisterRequest.name)
  return _internal_name();
}
inline void RegisterRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:lan.RegisterRequest.name)
}
inline std::string* RegisterRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:lan.RegisterRequest.name)
  return _internal_mutable_name();
}
...
inline void RegisterRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:lan.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:lan.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:lan.RegisterRequest.name)
}
...
inline std::string* RegisterRequest::release_name() {
  // @@protoc_insertion_point(field_release:lan.RegisterRequest.name)
...
inline void RegisterRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:lan.RegisterRequest.name)
}
...
inline const std::string& RegisterRequest::pwd() const {
  // @@protoc_insertion_point(field_get:lan.RegisterRequest.pwd)
  return _internal_pwd();
}
inline void RegisterRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:lan.RegisterRequest.pwd)
}
inline std::string* RegisterRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:lan.RegisterRequest.pwd)
  return _internal_mutable_pwd();
}
...
inline void RegisterRequest::set_pwd(std::string&& value) {
  ...
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:lan.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:lan.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:lan.RegisterRequest.pwd)
}
...
inline std::string* RegisterRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:lan.RegisterRequest.pwd)
...
inline void RegisterRequest::set_allocated_pwd(std::string* pwd) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:lan.RegisterRequest.pwd)
}
...
inline const ::lan::ResultCode& RegisterResponse::_internal_result() const {
  const ::lan::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::lan::ResultCode*>(
      &::lan::_ResultCode_default_instance_);
}
inline const ::lan::ResultCode& RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:lan.RegisterResponse.result)
  return _internal_result();
}
inline ::lan::ResultCode* RegisterResponse::release_result() {
  // @@protoc_insertion_point(field_release:lan.RegisterResponse.result)
  
  ::lan::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::lan::ResultCode* RegisterResponse::_internal_mutable_result() {
...
inline ::lan::ResultCode* RegisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:lan.RegisterResponse.result)
  return _internal_mutable_result();
}
inline void RegisterResponse::set_allocated_result(::lan::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:lan.RegisterResponse.result)
}
...
inline bool RegisterResponse::sucess() const {
  // @@protoc_insertion_point(field_get:lan.RegisterResponse.sucess)
  return _internal_sucess();
}
...
inline void RegisterResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:lan.RegisterResponse.sucess)
}
